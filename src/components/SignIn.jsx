...
function SignIn({ toogleForm }) {
  ...
  return (
    <div>
      ...
      <Header pagename=""/> 
      <Heading as="h1"textAlign="center" mt="2rem" color="#065666" >SignIn</Heading>
      <Flex
      direction="column"
      alignItems="center"
      mt="3rem"
      >
        <Flex
          ...
          >
          <Text mb="2rem" color="#065666" >Good to see you again :D</Text>
          ...
          bg="#065666"
          borderRadius="8px"
          mt="2rem" mb="3rem"color="white" variant="ghost" onClick={handleSignUp}
          _hover={{bg:"#0987A0"}}>
